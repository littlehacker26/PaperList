...
|MutiModel| Found in Translation:Learning Robust Joint Representations by Cyclic Translations Between Modalities|1. 现有的工作通过要求所有的模态作为输入来学习联合表示，因此学习到的表示在测试时可能对噪声或缺失的模态敏感，为此提出一种基于Seq2Seq自编码器的联合表示学习模型。 2.方法很简单，但是可以启发多关注多模态分析中的噪声问题。|
